...
function HRPartnershipContent() {
  ...
  const handleStartAssessment = async () => {
    ...
    if (managerData.email) {
      await captureEmailForTool(managerData.email, 'HR Partnership Assessment', 'hr-partnership')
    }
          ...
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-xl text-white/80 max-w-2xl mx-auto mb-8">
                We know managing people can be challenging. This assessment helps us understand where 
                you need support most, so we can better partner with you.
              </p>
            </div>
