...
export const config = {
  matcher: [
    // Skip Next.js internals, static files, and /sales (proxied to Railway)
    "/((?!_next|sales|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*)",
