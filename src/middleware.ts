...
export const config = {
  matcher: [
    // Skip Next.js internals, static files, and proxied routes (/sales, /lab on Railway)
    "/((?!_next|sales|lab|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*)",
