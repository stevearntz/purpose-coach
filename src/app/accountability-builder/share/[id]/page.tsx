...
import { Target, Users, Flag, BarChart3, Heart, UserCheck, Brain, DollarSign, Package, UserPlus, Shuffle, Settings, PiggyBank, RefreshCw, Shield, Clock, Calendar, Trophy, Zap, Plus } from 'lucide-react'
...
export default async function AccountabilityBuilderSharePage({ params }: Props) {
  ...
  return (
    <ToolSharePage 
      shareId={id}
      toolPath="/accountability-builder"
      toolConfig={{
        title: config.title,
