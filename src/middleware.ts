...
export const config = {
  matcher: [
    // Skip Next.js internals, static files, and proxied routes (/sales, /lab, /games on Railway)
    "/((?!_next|sales|lab|games|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*)",
